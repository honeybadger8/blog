...
# immutability-helper因React官方出镜，而被宠幸！
...
​　　相信大家在面试/工作中都遇到过js对象/数组的拷贝问题，面试官问你，你一般怎么做？？在现在ES6盛行的当下，不会一点ES6都不好意思说自己是前端(其实我一般都说自己是**攻城狮、切图崽**😝)，我们想的大多第一想法，如下：
+ `Object.assign` - 最方便;
+ `[...]` - 最有逼格;
...
　　嗯，今天的主题就是给大家分享一下，`Immutability Helpers`的一些用法，会介绍API的使用操作、小技巧和注意的点，如有理解不对：
　　
